...
describe MPC, '#sin' do
  it 'should calculate the arc cosine of a pure real argument' do
    data = [
  ...
  it 'should calculate the arc cosine of a pure imaginary argument' do
    data = [
  ...
  it 'should calculate the arc cosine with other precisions' do
